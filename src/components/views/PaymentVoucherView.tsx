            ...
            <tbody>
              {loading ? (
                ...
                <tr key={claim.claimIdInternal} className="border-b border-border hover:bg-muted/30">
                  ...
                  <td className="p-3 text-right">Rs. {(claim.submittedAmount ?? claim.amount).toFixed(2)}</td>
                  <td className="p-3 text-right font-medium">Rs. {claim.amount.toFixed(2)}</td>
            ...
            <div id="voucher-content">
              <div className="border-2 border-border rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm mb-4">
                  ...
                  <div><strong>Submitted Amount:</strong> Rs. {(voucher.submittedAmount ?? voucher.amount).toFixed(2)}</div>
                  <div><strong>Verified Payable:</strong> Rs. {(voucher.amount ?? 0).toFixed(2)}</div>
                </div>
                ...
                <div className="mt-3 p-3 bg-muted/20 rounded text-sm">
                  <div><strong>Submitted Total:</strong> Rs. {(voucher.submittedAmount ?? voucher.amount ?? 0).toFixed(2)}</div>
                  <div><strong>Final Verified Payable:</strong> Rs. {(voucher.amount ?? 0).toFixed(2)}</div>
                </div>
