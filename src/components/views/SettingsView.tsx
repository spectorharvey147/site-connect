        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between rounded-lg border border-border bg-muted/30 p-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">When enabled, verified claims go to the manager before super admin final approval. When disabled, they go directly to final approval.</p>
            </div>
            <Switch
